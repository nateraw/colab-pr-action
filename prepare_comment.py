...
def main(root_dir: str, repo_id: str, commit_sha: str):
    ...
    for notebook_path in notebook_paths:
        ...
        gh_link = f"https://github.com/{repo_id}/blob/{commit_sha}/{relpath}"
        gh_link_md = f"[{relpath}]({gh_link})"
        colab_link = f"https://colab.research.google.com/github/{repo_id}/blob/{commit_sha}/{relpath}"
